...
class CInit:
    ...
    def afficher_nombres_manettes():
        ...
        V.fenetre.blit(FCT.GFONT.get_image_texte("x" + str(V.nbManettes), 200, (0,0,0,255)) , (pX-20, pY+20))
        V.fenetre.blit(FCT.GFONT.get_image_texte("x" + str(V.nbManettes), 200, (255,255,255,255)) , (pX, pY))
        pygame.display.flip()   
